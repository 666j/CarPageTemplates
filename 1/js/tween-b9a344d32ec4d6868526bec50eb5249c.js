Array.prototype.indexOf || (Array.prototype.indexOf = function(n) {
    ...
    for (r = 0 > r ? Math.ceil(r) : Math.floor(r), 0 > r && (r += t); t > r; r++) if (r in this && this[r] === n) return r;
    return - 1
});
var TWEEN = TWEEN ||
function() {
    ...
    return {
        ...
        update: function(t) {
            ...
            var r = 0,
            i = n.length;
            for (t = void 0 !== t ? t: void 0 !== window.performance && void 0 !== window.performance.now ? window.performance.now() : Date.now(); i > r;) n[r].update(t) ? r++:(n.splice(r, 1), i--);
            return ! 0
        }
    }
} ();
TWEEN.Tween = function(n) {
    ...
    h = TWEEN.Interpolation.Linear,
    s = [],
    l = null,
    p = !1,
    E = null,
    I = null;
    for (var M in n) r[M] = parseFloat(n[M], 10);
    ...
    this.start = function(n) {
        TWEEN.add(this),
        p = !1,
        f = void 0 !== n ? n: void 0 !== window.performance && void 0 !== window.performance.now ? window.performance.now() : Date.now(),
        f += a;
        for (var o in i) {
    ...
    this.update = function(n) {
        ...
        for (var w in i) {
            var d = r[w] || 0,
            O = i[w];
            O instanceof Array ? t[w] = h(O, v) : ("string" == typeof O && (O = d + parseFloat(O, 10)), t[w] = d + (O - d) * v)
        }
        if (null !== E && E.call(t, v), 1 == M) {
            if (e > 0) {
                isFinite(e) && e--;
                for (var w in u)"string" == typeof i[w] && (u[w] = u[w] + parseFloat(i[w], 10)),
                r[w] = u[w];
                return f = n + a,
                !0
            }
...
TWEEN.Easing = {
    ...
    Elastic: {
        ...
        InOut: function(n) {
            var t, r = .1,
            i = .4;
            return 0 === n ? 0 : 1 === n ? 1 : (!r || 1 > r ? (r = 1, t = i / 4) : t = i * Math.asin(1 / r) / (2 * Math.PI), (n *= 2) < 1 ? -.5 * r * Math.pow(2, 10 * (n -= 1)) * Math.sin((n - t) * 2 * Math.PI / i) : .5 * r * Math.pow(2, -10 * (n -= 1)) * Math.sin((n - t) * 2 * Math.PI / i) + 1)
        }
    },
    Back: {
        In: function(n) {
